...
function AdminMenu() {
  ...
  return (
    <div className="container">
      ...
      <button style={{marginLeft:"1000px", marginBottom:"20px"}} className="button" onClick={handleAdd}>
        Add Category
      </button>
      ...
      {showModal && (
        <div className="modal-container">
          ...
          <div className="modal-body">
            ...
            <div>
              <button onClick={handelEditModal} className="button">Edit</button>
            </div>
          </div>
        </div>
      )}
      {showAddModal && (
        <div className="modal-container">
          ...
          <div className="modal-body">
            ...
            <div>
              <button onClick={handelAddModal} className="button">Add</button>
            </div>
          </div>
        </div>
      )}
